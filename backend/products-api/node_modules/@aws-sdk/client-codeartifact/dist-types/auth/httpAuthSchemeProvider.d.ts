 ...
 * @internal
 */
export interface CodeartifactHttpAuthSchemeParametersProvider extends HttpAuthSchemeParametersProvider<CodeartifactClientResolvedConfig, HandlerExecutionContext, CodeartifactHttpAuthSchemeParameters, object> {
}
/**
 * @internal
 */
export declare const defaultCodeartifactHttpAuthSchemeParametersProvider: (config: CodeartifactClientResolvedConfig, context: HandlerExecutionContext, input: object) => Promise<CodeartifactHttpAuthSchemeParameters>;
/**
 * @internal
 */
